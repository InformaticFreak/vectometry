...
![visitors](https://visitor-badge.laobi.icu/badge?page_id=informaticfreak/vectometry)&nbsp;
...
See the change log [here](CHANGELOG.md) and [send Feedback](https://forms.office.com/r/CbG2G1aCDf).
